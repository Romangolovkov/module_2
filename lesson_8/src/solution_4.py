workers = ['Снабжение, Менеджер, Иванов', 'Дизайн, Дизайнер, Смирнов', 'Снабжение, Менеджер, Петров', 'Дизайн, Иллюстратор, Сидоров', 'Маркетинг, Аналитик, Сергеев', 'Дизайн, Дизайнер, Васильев']
